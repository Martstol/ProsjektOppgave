...
\begin{table}[h]
	...
	\egroup
	\end{center}
	\caption{Usage of the nabla operator in Computational Fluid Dynamics.}
...
the partial derivatives of each component of the vectors in a vector field. While 
the Laplacian is the application of divergence operator to the result of the 
gradient operator. 
...
\begin{description}
	...
	velocity causes it's density and other properties to change along with the 
	flow. The fluid is \emph{advected} along it's velocity field. 
